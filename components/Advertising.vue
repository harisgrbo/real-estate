      ...
      <fieldset>
        <div class="rounded-md bg-yellow-50 p-4">
          <div class="flex">
            ...
            <div class="ml-3">
              <h3 class="text-sm font-medium text-yellow-800">Cijene u testnoj fazi su isključivo pokaznog karaktera.</h3>
            </div>
          </div>
        </div>
              ...
              <div class="flex flex-col w-full">
                <div class="flex flex-row justify-between w-full justify-between items-center">
                  <div class="h-full w-full mr-6 flex flex-col justify-between">
                    ...
                    <div class="text-2xl font-semibold" v-if="selectedDuration !== null && selectedAdvertisement === option.id">
                      <div v-if="calculatedPriceLoaded">{{ calculatedPrice.price + ' KM - ' + (calculatedPrice.discount * 100.0).toFixed(0) + ' % popusta' }}</div>
