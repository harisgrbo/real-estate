  ...
  <div class="modal-inner">
    ...
    <div class="modal-content">
      <div class="w-full flex items-center justify-between">
        ...
        <action-button placeholder="Sponzoriši oglas" :style-options="{ width: '100%', marginLeft: '6px'}" @action="$emit('remove-listing', this.listing_id)" :loading="loading"></action-button>
      </div>
