            ...
            <div class="overflow-hidden relative">
                <div v-if="listing.thumbnail_url !== null" class="wrapper">
                    <transition name="fade">
                        <nuxt-img class="main-image" :src="listing.thumbnail_url" @load="onLoaded" v-show="loaded" alt="" />
                    </transition>
                </div>
            ...
            <div class="listing-card-content relative">
                <div class="flex flex-col justify-between items-start">
                    ...
                    <div class="icons-date flex flex-row items-center justify-between w-full" v-if="listing.price != 0">
                        <div class="important">
                            <p :class="['new', listing.has_discount ? 'cross' : '']">
                                {{ parseInt(listing.price).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ".") }} KM</p>
                            <p v-show="listing.listing_type === 'Stan na dan' && !listing.has_discount" class="pl-2">/
                                noć {{ listing.per_guest ? 'po osobi' : '' }}</p>
                        </div>
                        <div class="important" v-if="listing.has_discount">
                            ...
                            <p v-show="listing.listing_type === 'Stan na dan'" class="pl-2">/ noć
