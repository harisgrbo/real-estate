        ...
        <div class="w-full">
          <div class="w-full flex flex-col items-center justify-between" v-if="isMe">
            <div class="w-full flex items-center justify-center">
              ...
              <ActionButton v-if="listing.completed_at === null" :style-options="{ color: '#fff', background: 'red' }"  placeholder="Završi" @action="$emit('finish-listing')" class="w-full ml-sm"></ActionButton>
            </div>
        ...
        <form @submit.prevent>
          ...
          <div v-show="numOfDays" class="mb-4 w-full flex total flex-col">
            ...
            <div class="flex w-full flex-col items-start justify-between">
              ...
              <div class="font-thin mb-2 text-md w-full flex flex-row items-center justify-between" v-if="perguest">Broj gostiju: <span>{{ number_of_guests }}</span></div>
