<template>
    <div class="chat-inner"  @mouseleave="$emit('chat-not-hovered')" @mouseover="$emit('chat-hovered')">
        <LoadingBar :override="loadingMobileMessages"/>

        <!-- BEGIN: Content -->
        <div class="flex w-full">
            <div v-show="!conversationsLoaded" src="/loader.svg" class="flex min-h-full min-w-full items-center justify-center" style="height: 500px">
                <img src="/loader.svg" alt="">
            </div>
            <div v-show="conversationsLoaded" class="w-full">
                <div v-if="conversations.length > 0" class="chat flex flex-row w-full">
                                    ...
                                    <div v-for="(conversation, index) in conversations" :key="index"
                                        ...
                                        <div class="ml-2 overflow-hidden w-full h-full">
                                            <div class="flex items-center w-full">
                                                ...
                                                <div class="text-xs text-gray-500 font-medium ml-auto">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    class="w-full flex items-center flex-row truncate text-sm text-gray-900"
                                                ...
                                                <div class="w-full truncate text-gray-900 text-sm font-medium"
                                                     v-else>
                    ...
                    <!-- END: Chat Side Menu -->
                    <!-- BEGIN: Chat Content -->
                    <div v-if="selectedConversation !== null" class="flex w-full relative main-content rounded-md">
                            ...
                            <div v-if="currentConversation" class="h-full flex flex-col">
                                <div class="custom-header flex flex-row items-center justify-between">
                                    <div class="flex flex-row items-center">
                                        <button @click="selectedConversation = null" class="mr-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                    ...
                                    <div class="flex flex-row items-center options-dropdown" v-show="showOptions">
                                        <div
                                            class="flex items-center w-full justify-start border-gray-200 cursor-pointer py-2 hover:bg-gray-50 rounded-md"
                                        ...
                                        <div
                                            ...
                                            <p class="font-medium text-sm">Izbriši razgovor</p>
                                        </div>
                                    </div>
                                </div>
                                <div v-show="messagesLoaded" ref="messageContainer" class="messages-wrapper">
                                    ...
                                    <div v-for="message in messages" :key="message.id">
                                        <div :class="[isMe(message) ? 'float-right' : 'float-left']"
                                             class="chat__box__text-box flex items-end mb-2">
                                            <div v-if="message.message_type === 'text'"
                                                 :class="[isMe(message) ? 'bg-gray-100 border border-gray-300 p-2 text-gray-900 rounded-l-lg text-md leading-6 rounded-t-lg text-right' : 'not-me-box border border-gray-300 p-2 text-md leading-6 font-medium text-gray-700 rounded-r-lg rounded-t-lg']">
                                                {{ message.content }}
                                            ...
                                            <div v-else-if="message.message_type === 'listing'"
                                                 :class="['add-border', isMe(message) ? 'px-2 py-2 text-gray-700 rounded-l-md bg-gray-50 rounded-t-md text-right' : 'px-2 py-2 text-gray-700 rounded-r-md shadow-md rounded-t-md']">
                                ...
                                <div
                                    class="pt-2 pb-2 flex items-center justify-between border-t border-gray-400 dark:border-dark-5 px-2 mobile-message-wrapper">
                                    <VEmojiPicker
                                        v-if="showEmoji"
                                        @select="selectEmoji"
                                        v-on-clickaway="away"
