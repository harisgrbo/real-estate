            ...
            <div class="flex">
                ...
                <div class="ml-3">
                    ...
                    <div class="mt-2 text-sm text-yellow-700">
                        ...
                        <p class="text-xs mt-2">Ako ne vidite poruku provjerite spam folder, ako i dalje ne možete
                            pronaci email pritisnite dugme ispod</p>
                        <ActionButton @action="resendVerificationMail()" class="mt-3" :loading="loadingResend"
                                      placeholder="Pošalji ponovo"></ActionButton>
                    </div>
                </div>
            </div>
        </div>
        <ul>
            <li v-if="$auth.user" class="user-label" @click="goToUser">
                ...
                <div class="user-wrap w-full">
                    <dd class="w-full flex flex-col items-start justify-between">
                        <h2 class="text-md font-medium text-black leading-5 text-left">{{ $auth.user.name }}</h2>
                        <span
                            class="px-2 py-1 text-green-800 sub-role font-semibold uppercase bg-green-100 rounded-sm mt-1">{{
            ...
            <li>
                ...
                <nuxt-link to="/moj-racun/spaseno">Spašeni oglasi</nuxt-link>
            </li>
            <li>
