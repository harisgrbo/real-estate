<template>
    <div class="sidenav-wrapper flex flex-col justify-between h-full">
        <div class="w-full flex w-full items-center min-w-full justify-between pt-4">
            <h3 class="w-full">Meni</h3>
            <svg @click="$emit('close-sidenav')" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 close" fill="none"
                ...
                <div class="ml-3">
                    ...
                    <div class="mt-2 text-sm text-yellow-700">
                        ...
                        <p class="text-xs mt-2">Ako ne vidite poruku provjerite spam folder, ako i dalje ne možete
                            pronaci email pritisnite dugme ipod</p>
            ...
            <li v-if="$auth.user" class="user-label">
                ...
                <div class="user-wrap w-full">
                    <dd class="mt-3 w-full flex flex-row items-center justify-between">
                        ...
                        <span class="px-2 py-1 text-green-800 text-xs font-semibold uppercase bg-green-100 rounded-sm">{{
