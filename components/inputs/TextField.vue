<template>
    <div class="relative w-full flex flex-col items-start">
        <div
            class="relative border text-wrap border-gray-300 rounded-md px-3 py-2 shadow-sm focus-within:ring-1 focus-within:text-gray-900 focus-within:ring-gray-900 focus-within:ring-gray-900 focus-within:border-gray-900">
            <label for="name"
        ...
        <span v-if="currency" class="text-gray-500 sm:text-sm font-semibold flex flex-row items-center"
          ...
          KM
           <p v-if="showSquareM" class="pl-1">/ m²</p>
                ...
                <span v-if="discount" class="text-gray-900 sm:text-sm font-semibold flex flex-row items-center"
                      id="price-currency">
          %
        </span>
            </div>
