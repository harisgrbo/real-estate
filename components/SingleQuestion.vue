                        ...
                        <div class="min-w-0 flex-1">
                            <div>
                                ...
                                <p class="mt-0.5 text-sm text-gray-500">
                                    {{ $moment(message.created_at).format('DD.MM.YYYY') }} u
                    ...
                    <div class="relative flex items-start space-x-3">
                        ...
                        <div class="min-w-0 flex-1 py-1.5">
                            <div class="text-sm text-gray-500">
                                <div class="font-medium text-gray-900" v-if="reply && reply.user"> {{
                                        reply.user.name
                                    }}
                                </div>
                                je odgovorio
                    ...
                    <div class="relative flex items-start space-x-3">
                        ...
                        <div class="min-w-0 flex-1 py-1.5">
                            <div class="mt-1 sm:mt-0 sm:col-span-2">
                                <textarea v-model="replyTerm" id="about" name="about" rows="3"
                                          class=" min-w-full shadow-sm block w-full focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border border-gray-300 rounded-md"></textarea>
                                <p class="mt-2 text-sm text-gray-500">Odgovori na pitanje</p>
                            </div>
                            <ActionButton placeholder="Odgovori" class="max-w-sm"
                                          @action="replyToQuestion"></ActionButton>
                        </div>
                    </div>
                </div>
            </li>
