                ...
                <div class="w-full">
                    <div class="options-wrap">
                        <div class="flex-1 mt-6 xl:mt-0 w-full">
                            <div
                                class="w-full grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 up:grid-cols-2 xl:grid-cols-2 gap-4">
                                <TextField type="text" label="Ime" placeholder="john doe" v-model="name"
                                           class="mb-3"></TextField>
                                <TextField type="text" label="Email" placeholder="johndoe@mail.com" v-model="email"
                                           class="mb-3"></TextField>
                                <TextField type="text" label="Broj mobitela" placeholder="+387 61 111 222"
                                           v-model="phoneNumber" class="mb-3"></TextField>
                                <TextField type="text" label="Adresa" placeholder="ulica i broj.." v-model="address"
                                           class="mb-3"></TextField>
                                <TextField type="password" label="Šifra" placeholder="******" v-model="password"
                                           class="mb-3"></TextField>
                                <TextField type="password" label="Ponovi Šifru" placeholder="******"
                                           v-model="passwordConfirm" class="mb-3"></TextField>
                            </div>
                            <action-button class="mt-5 mb-4" @action="updateProfileInfo"
                        ...
                        <div class="flex flex-col sm:ml-0 xl:ml-6 lg:ml-6 up:ml-6 xl:ml-6">
                            <div
                                ...
                                <div class="mx-auto cursor-pointer relative mt-5 picture">
                                    <action-button @action="updateProfileInfo"
                                                   placeholder="Promijeni sliku"></action-button>
