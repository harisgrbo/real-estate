  ...
  <div class="account-wrapper max-w-7xl mx-auto w-full">
    ...
    <div class="flex flex-row pb-8 justify-between">
      ...
      <ul class="divide-y divide-gray-200 w-full mr-4 pr-4">
        <li class="relative bg-white py-5 px-4 hover:bg-gray-50 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600" v-for="(notification, index) in notifications" :key="index">
      ...
      <form class="w-full space-y-8 divide-y divide-gray-200 bg-gray-50 p-4">
