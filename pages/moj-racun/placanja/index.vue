        ...
        <div class="content-wrapper">
            ...
            <div class="saved-content">
                <div v-show="activeTab === 0">
                    ...
                    <TextField type="text" label="Iznos u KM" placeholder="npr 5" v-model="balance"
                ...
                <div class="modal-content places-modal pt-4">
                        ...
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                <p class="text-sm text-yellow-700">
                                    Da li ste sigurni da želite uplatiti sredstva na račun, ova akcija se ne može
                                    vratiti!
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="flex flex-row items-center justify-between">
                        <action-button :style-options="{ marginRight: '8px', width: '100%' }"
                                       @action="deposit(); $modal.hide('deposit')" placeholder="Da"></action-button>
                        <action-button :style-options="{ marginLeft: '8px', width: '100%' }" placeholder="Ne"
                                       @action="$modal.hide('deposit')"></action-button>
                    </div>
                </div>
            </div>
        </modal>
