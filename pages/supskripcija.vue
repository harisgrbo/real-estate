<template>
  ...
  <div class="bg-white preview-wrapper-inner">
    <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
      <div class="sm:flex sm:flex-col sm:align-center">
        <h1 class="text-5xl font-extrabold text-gray-900 sm:text-center">Cjenovnik paketa</h1>
      ...
      <div class="mt-12 space-y-4 sm:mt-16 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-6 lg:max-w-4xl lg:mx-auto xl:max-w-none xl:mx-0 xl:grid-cols-4">
        <div class="border border-gray-400 rounded-lg shadow-sm divide-y divide-gray-200">
          <div class="p-6">
...
export default class Supskripcija extends Vue {
}
</script>
