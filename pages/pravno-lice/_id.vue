            ...
            <aside class="w-96 bg-white overflow-y-auto">
              <div class="col-span-1 flex flex-col text-center bg-white rounded-lg divide-y divide-gray-200">
                <div class="flex-1 flex flex-row justify-start user-inner">
                  <nuxt-img class="w-44 h-44 flex-shrink-0 rounded-sm object-contain" :src="user.avatar_url !== null ? user.avatar_url  : '/noimage.jpeg'" alt="" />
                  <div class="ml-6">
                    ...
                    <div class="flex flex-row items-center justify-start w-full verified">
                      <nuxt-img :src="user.verified ? '/001-completed.png' : '/002-error.png'" alt="" />{{ user.verified ? 'Verifikovan email' : 'Nije verifikovan email' }}
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div class="flow-root">
                    <div class="-my-12 divide-y divide-gray-200">
                      <div v-for="review in reviews" :key="review.id" class="py-12 review-user">
                        <div class="flex items-center">
                          <nuxt-img :src="user.avatar_url !== null ? user.avatar_url : '/noimage.jpeg'" :alt="user.name" class="h-12 w-12 rounded-full" />
                          <div class="ml-4">
