    ...
    <div class="form-wrapper">
        <div class="inner">
            ...
            <form @submit.prevent="handleResetPassword">
                <TextField type="password" label="Nova šifra" id="1" placeholder="******" v-model="newPassword"
                           class="mb-6 mt-1"></TextField>
                <TextField type="password" label="Ponovite šifru" id="2" placeholder="******"
                           v-model="repeatNewPassword" class="mb-6 mt-1"></TextField>
                ...
                <ActionButton class="w-full" :style-options="{ color: '#fff', marginTop: '24px' }" :loading="loading"
                              type="submit" placeholder="Resetuj šifru"></ActionButton>
            </form>
        </div>
    </div>
</template>
