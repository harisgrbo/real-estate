    ...
    <div class="preview-wrapper-inner bg-white w-full px-20">
        <div class="account-wrapper-inner">
            <div class="sidenav w-full">
                <h1 class="heading-account"><b>{{ investors.length }}</b> investitora</h1>
                <div class="grid-layout" v-if="investorsLoaded">
                    <UserCard v-for="investor in investors" :id="investor.id" :user="investor" :key="investor.id"/>
                </div>
...
export default class Investitori extends Vue {
    investors = [];
