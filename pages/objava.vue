        ...
        <div class="content-wrapper flex flex-col">
            ...
            <div v-show="currentStep === steps.STEP_ONE" class="step-1 test">
                <div class="inner">
                    ...
                    <Categories v-show="category === null" @selected-category="handleSelectedCategory"/>
                    <div class="inner" v-show="category !== null">
                        <h2 class="test" v-if="currentStep === steps.STEP_TWO">
                            Šta želite uraditi sa vašom nekretninom?
                        </h2>
                        <PublishRadioButton :options="listingTypes" v-model="listingType" :error="errors.listingType.error"
                                            :error-message="errors" @input="nextStep"></PublishRadioButton>
                    </div>
                </div>
            </div>

            <div v-show="currentStep === steps.STEP_TWO">
                <div class="grid grid-cols-2 gap-5">
                    ...
                    <TextField type="text" label="Adresa" placeholder="npr. Titova 16" v-model="address"></TextField>
                    <div class="flex flex-col">
                        <TextField type="text" label="Naselje" placeholder="npr. Dolac Malta" v-model="district"></TextField>
                    </div>
                </div>
                <div class="inner checkboxes mt-5">
                    <h2 class="test" v-if="currentStep === steps.STEP_FOUR">
                        Unesite cijenu nekretnine
                    </h2>
                    <TextField type="number"
                               :label="listingType !== null && listingType.shortname === 'booking' ? 'Cijena noćenja' : 'Cijena'"
                ...
                <div class="inner mt-6 mb-6">
                    <div>
                        <div v-for="attr in ordinaryGlobalAttributes" :key="attr.id" class="mb-5">
                    ...
                    <h1 class="heading-checkbox mt-4">Dodatni filteri</h1>
                ...
                <div class="inner">
                    <TextAreaField label="Opišite vašu nekretninu"></TextAreaField>
                </div>
            </div>
