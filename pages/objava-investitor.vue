<template>
    <div class="publish-wrapper-inner relative">
        <div class="left">
            <nuxt-link
                class="absolute top-6 z-10 left-6 bg-white cursor-pointer h-10 w-10 rounded-md flex items-center justify-center back-to-index"
                to="/">
        ...
        <div class="content-wrapper flex flex-col">
            ...
            <div v-show="currentStep === steps.STEP_TWO" class="step-2 test">
                <div class="inner">
                    ...
                    <div class="relative w-full flex flex-col mb-6">
                        <DropdownAutocomplete label="Grad" @select-option="handleSelectedCity"
                                              placeholder="Npr. Sarajevo - Centar"></DropdownAutocomplete>
                    </div>
                    <TextField type="text" label="Adresa" placeholder="npr. Titova 16" v-model="address"
                               class="mb-6"></TextField>
                    <div class="flex flex-col mt-6">
                        <TextField type="text" label="Naselje" placeholder="npr. Dolac Malta" v-model="district"
                                   class="mb-6"></TextField>
                    </div>
                </div>
            ...
            <div v-show="currentStep === steps.STEP_THREE" class="step-3 test flex flex-col">
                <div class="inner checkboxes">
                    ...
                    <TextField class="mb-6" type="number"
                               :label="listingType !== null && listingType.shortname === 'booking' ? 'Cijena noćenja' : 'Cijena od'"
                               placeholder="100000" v-model="price" :currency="true"
                               :square="price_per_square"></TextField>
                    <TextField type="number"
                               :label="listingType !== null && listingType.shortname === 'booking' ? 'Cijena noćenja' : 'Cijena do'"
                               placeholder="300000" v-model="price" :currency="true"
                               :square="price_per_square"></TextField>
                    <div
                        class="flex flex-col xl:flex-row lg:flex-row up:flex-row items-center justify-between pt-4 mt-4">
                        ...
                        <div class="switch-wrap ml-0 lg:ml-2 xl:ml-2 up:ml-2"
                             v-show="listingType && listingType.shortname === 'booking'">
                            <div class="switch">
            ...
            <div v-show="currentStep === steps.STEP_SIX" class="step-6 test">
                <div class="inner pt-20 pb-52">
                    ...
                    <TextAreaField class="mt-10" label="Youtube iframe (video)" type="text"
                                   placeholder="https://youtube.com/1wts5" v-model="video_url"></TextAreaField>
                </div>
                    ...
                    <div class="w-full flex flex-col">
                        <div class="flex flex-row items-center">
                            <div class="create-unit w-full grid grid-cols-5 gap-3">
                                <TextField type="text" label="Jedinica" placeholder="npr. Stan a1"
                                           v-model="unitPayload.unit_name" class="mb-6"></TextField>
                                <TextField type="text" label="Sprat" placeholder="npr. 1"
                                           v-model="unitPayload.unit_floor" class="mb-6"></TextField>
                                <TextField type="text" label="Kvadratura" placeholder="npr. 43"
                                           v-model="unitPayload.unit_surface" class="mb-6"></TextField>
                                <TextField type="text" label="Broj soba" placeholder="npr. 3"
                                           v-model="unitPayload.unit_rooms" class="mb-6"></TextField>
                                <TextField type="text" label="Cijena" placeholder="npr. 100000"
                                           v-model="unitPayload.unit_price" class="mb-6"></TextField>
                            </div>
                                        ...
                                        <table class="min-w-full divide-y divide-gray-200">
                                            ...
                                            <tr v-for="(unit, index) in units" :key="index">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                    <a href="#"
                                                       class="text-indigo-600 hover:text-indigo-900">Izbriši</a>
                                                </td>
                                            </tr>
            ...
            <div v-show="currentStep === steps.STEP_EIGHT" class="step-8 test">
                <div class="inner">
                    ...
                    <div class="img-upload-wrapper">
                        <dropzone ref="dropzone" :options="dropzoneOptions" :destroy-dropzone="false"
                                  @vdropzone-processing="dropzoneChangeUrl" @vdropzone-sending="sendImages"></dropzone>
                    </div>
                </div>
                <div class="button-wrapper">
                    <button @click="prevStep" class="back">Nazad
            ...
            <div v-show="currentStep === steps.STEP_NINE" class="step-9 test">
                ...
                <div class="button-wrapper">
                    ...
                    <ActionButton :loading="finishLoader" @action="nextStep" placeholder="Završi"
                                  :style-options="{ color: '#fff' }"></ActionButton>
                </div>
            </div>
        </div>
    </div>
