<template>
  <div ref="home" :class="['home-wrapper', $route.name === 'objava' || $route.name === 'moj-racun-poruke' || $route.name === 'oglas-slug' || $route.name === 'pretraga' ? 'objava' : '', $route.name === 'moj-racun-poruke' || $route.name === 'korisnik-id' || $route.name === 'agencija-id' || $route.name === 'agent-id' ? 'poruke' : '']">
    <div
      class="header"
